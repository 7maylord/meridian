...
export const MERIDIAN_MARKET_ABI = [
  ...
  'function getSellRefund(uint256 marketId, bool isYes, uint256 shares) external view returns (uint256)',
  'function getSellRefundInternal(uint256 marketId, bool isYes, uint256 shares) external view returns (uint256)',
  'function builderFeeRate() external view returns (uint16)',
  'function feeCollector() external view returns (address)',
  'function setFeeCollector(address feeCollector) external',
  'function setBuilderFeeRate(uint16 rate) external',
