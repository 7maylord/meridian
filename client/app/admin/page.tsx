    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] max-w-md mx-auto text-center space-y-6">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Connect your authorized verifier wallet to resolve Tier 2 prediction
          markets.
        </p>
        <button
          onClick={() => login()}
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] max-w-md mx-auto text-center space-y-6">
        ...
        <p className="text-muted-foreground leading-relaxed">
          ...
          <span className="font-mono text-xs block mt-2 text-white/70">
            {address}
          </span>{" "}
          is not an authorized verifier on the ResolutionOracle contract.
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-8 max-w-5xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Resolve Tier 2 markets securely on-chain.
          </p>
        </div>
      </div>
      ...
      <div className="glass-panel p-6">
        <h3 className="text-lg font-semibold mb-6">
          Pending Resolutions ({pendingResolutions.length})
        </h3>
